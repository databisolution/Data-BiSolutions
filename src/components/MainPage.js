...
const MainPage=() => {
    return (
        ...
        <div className=' mx-auto z-0 w-full px-1'>
            ...
            <img src={MainImage} alt="mainImage" className=' mx-auto pb-8  sm:h-[250px] w-full md:w-full object-cover'/>  {/*py-32 h-[600px] w-[1400px] object-cover*/}
            </div>
        <div className='h-full mx-auto mb-10 ' > {/*h-full w-[1200px] mx-auto mb-10*/}
            <p className='text-xl' data-aos="zoom-in" data-aos-duration="1500">Des informations multi-sources, 
        ...
        <p className='text-xl py-5'>Des entreprises comme la vôtre réalise chaque jour des projets BI pour améliorer leur quotidien</p>
        <Link to='/contact'>
