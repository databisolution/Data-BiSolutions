  ...
  return (
    <section className='pt-52' data-aos="">
         {/* <div className=' mx-auto z-0'>
            ...
            <h2 className='text-3xl' data-aos="zoom-in-down"  data-aos-duration="2100">Les apports de Microsoft POWER BI et Microsoft AZURE SYNAPSE</h2>
            <div className='border-b-[2px] mx-auto w-52 p-4'></div>
            <div>
              <h3>Microsoft POWER BI</h3>
              <p className='mx-auto py-4 text-3xl' data-aos="zoom-in-down"  data-aos-duration="2500">Les avantages de Power BI sont nombreux pour aider les équipes de direction à faire des choix rapides sans compromettre la rentabilité de leur entreprise. 
                ...
                <img className='mx-auto py-4 ' src={PowerBi} alt='powerBi' data-aos="zoom-in-down"  data-aos-duration="1800"/>
              ...
              <div>
                ...
                <img className='mx-auto py-4 ' src={Azure} alt='Azure' data-aos="zoom-in-down"  data-aos-duration="00"/>
                <p className='mx-auto py-2 text-3xl' data-aos="zoom-in-down"  data-aos-duration="1800">C’est l’outil qui facilite le circuit de traitement de la donnée. 
                ...
                <p className='mx-auto py-6 text-3xl' data-aos="zoom-in-down"  data-aos-duration="1800">Il n’existe pas de méthode unique pour réaliser un projet BI. 
              ...
              <button className="text-3xl p-8 bg-blue-400 rounded-full my-10 p-3 transition ease-in-out delay-150 
