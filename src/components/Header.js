...
const Header = ({namePage,desc}) => {
  return (
    ...
    >
      ...
      <p className="text-white top-[390px] mr-2 lg:top-[200px] 2xl:text-4xl xl:text-2xl text-justify absolute w-[300px] lg:w-[500px] 2xl:w-[800px] right-[20px] m-10 2xl:leading-[50px] rounded-lg backdrop-blur-[7px]">{desc}</p>
    </div>
  );
};
