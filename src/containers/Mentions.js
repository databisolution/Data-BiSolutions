  ...
  return (
    <section className="w-[300px] 3xl:w-[1500px] 2xl:w-[1200px] xl:w-[1000px] lg:w-[800px] md:w-[650px] xm:w-[500px] sm:w-[320px] mx-auto mt-52 mLegal">
      <div>
        ...
        <h3 className="text-left font-bold underline mt-10">Lois applicables</h3>
        <p className="text-left">
          Conformément au Règlement général sur la protection des données
          (RGPD), cette politique de confidentialité est conforme aux règlements
          suivants. Les données à caractère personnel doivent être :
        </p>
        <ul className="text-left">
          ...
          <li>
            ...
            elles sont traitées, soient effacées ou rectifiées sans
            tarder(exactitude) ;{" "}
          </li>
          <li>
            ...
            statistiques conformément à l'article 39, paragraphe 1, pour autant
        ...
        <h3 className="text-left font-bold underline mt-20">Données personnelles que nous collectons</h3>
        <h4 className="text-left font-bold">Données collectées automatiquement</h4>
        <p className="text-left">
        ...
        <h3 className="text-left font-bold underline mt-10">Données recueillies de façon non automatique</h3>
        <p className="text-left">
        ...
        <p className="text-left">
          ...
          informer au préalable. Comment nous utilisons les données personnelles
        ...
        <h3 className="text-left font-bold underline mt-10">Avec qui nous partageons les données personnelles</h3>
        ...
        <p className="text-left">
          Nous ne partageons pas les données utilisateur avec les tien suivants
          : Nous pouvons partager les données utilisateur avec des tiers aux
          fins suivantes : Les tiers ne seront pas en mesure d'accéder aux
          données des utilisateurs au-delà de ce qui est raisonnablement
          nécessaire pour atteindre Les tiers ne seront pas en mesure d'accéder
          aux données des utilisateurs au-delà de ce qui est raisonnablement
        ...
        <h3 className="text-left font-bold underline mt-10">Combien de temps nous stockons les données personnelles</h3>
        <p className="text-left">
        ...
        <h3 className="text-left font-bold underline mt-10">Comment nous protégeons vos données personnelles</h3>
        <p className="text-left">
        ...
        <h3 className="text-left font-bold underline mt-10">Vos droits en tant qu'utilisateur</h3>
        <p className="text-left">
          En venu du RGPD, les utilisateurs ont les droits suivants en tant que
        ...
        <p className="text-left">
          ...
          protection de la vie privée ici : info@databisolutions.fr
        </p>
        <h3 className="text-left font-bold underline mt-10">Politique sur les cookies</h3>
        <p className="text-left">
          ...
          relatives aux habitudes de navigation de l'utilisateur. Nous utilisons
          les types de cookies suivants sur notre site :
        </p>
        <ul className="text-left">
        ...
        <p className="text-left">
          ...
          qu'un cookie est transmis. Vous pouvez également choisir de désactiver
          les cookies entièrement dans votre navigateur Internet, mais cela peut
