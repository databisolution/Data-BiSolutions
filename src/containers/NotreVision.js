...
const NotreVision = () => {
  return (
    <>
      ...
      <section className="h-[3850px] sx:h-[3800px] 2xl:h-[4200px]">
        <div>
...
<div className="relative w-full sx:w-[500px] md:w-[600px] lg:w-[800px] 2xl:w-[1000px] h-[1000px] 2xl:h-[1200px] bgImg rounded-md sx:mx-auto mt-20 sx:mt-12 max-sx:bg-transparent">
        ...
        <div className="relative w-full sx:w-[500px] md:w-[600px] lg:w-[800px] 2xl:w-[1000px] mx-auto">
          <div
            data-aos="fade-right"
            data-aos-duration="1000"
            className="sx:absolute max-sx:mt-10 max-sx:mx-auto sx:left-[-45px] sx:mt-[140px] w-[290px] slg:w-[300px] md:w-[350px] lg:w-[500px] 2xl:w-[700px] 2xl:h-[420px] h-[320px] bg-slate-900 rounded-md"
          >
            <img
              className="object-cover w-[290px] slg:w-[300px] md:w-[350px] lg:w-[500px] 2xl:w-[700px] 2xl:h-[420px] h-[320px] rounded-md"
              src={rpa}
          ...
          <div
            data-aos="fade-left"
            data-aos-duration="1000"
            className="p-12 max-sx:top-[190px] max-xm:mx-auto max-xm:px-10 text-left w-full absolute sx:right-[-40px] sx:mt-[175px] sx:w-[400px] md:w-[500px] 2xl:h-[350px] 2xl:leading-8 sm:leading-4 leading-4 text-sm 2xl:text-md h-[250px] bg-slate-100 rounded-md shadow-xl"
          >
        ...
        <div className="relative w-full sx:w-[500px] md:w-[600px] lg:w-[800px] 2xl:w-[1000px] mx-auto">
          <div
            data-aos="fade-left"
            data-aos-duration="1000"
            className="sx:absolute 2xl:top-[120px] max-sx:mt-48 max-sx:mx-auto sx:right-[-45px] sx:mt-[540px] w-[290px] slg:w-[300px] md:w-[350px] lg:w-[500px] 2xl:w-[700px] 2xl:h-[420px] h-[320px] bg-slate-900 rounded-md"
          >
            <img
              className="object-cover w-[290px] slg:w-[300px] md:w-[350px] lg:w-[500px] 2xl:w-[700px] 2xl:h-[420px] h-[320px] rounded-md"
              src={security}
          ...
          <div
            data-aos="fade-right"
            data-aos-duration="1000"
            className="p-12 max-sx:top-[200px] 2xl:top-[120px] max-xm:mx-auto max-xm:px-10 text-left w-full absolute sx:left-[-40px] mt-[10px] sx:mt-[575px] sx:w-[400px] md:w-[500px] 2xl:h-[350px] 2xl:leading-8 sm:leading-4 leading-4 text-sm 2xl:text-md h-[250px] bg-slate-100 rounded-md shadow-xl"
          >
        ...
        <h2 className="relative top-[10px] sx:top-[40px]  xl:top-[30px] 2xl:top-[40px] font-extrabold text-2xl text-black">
          Optimisez le temps de vos équipes et améliorez les process avec des
          applications métiers
        </h2>


<div className="relative w-full sx:w-[500px] md:w-[600px] lg:w-[800px] 2xl:w-[1000px] h-[1000px] 2xl:h-[1200px] bgImg rounded-md sx:mx-auto mt-20 sx:mt-12 max-sx:bg-transparent top-[-1000px]">
        ...
        <VisionLi
          ...
          />
         <div className="relative top-[-365px] sx:top-[-40px] 2xl:top-[-40px] sx:my-10 w-44 h-1 bg-cyan-500 mx-auto rounded-md"></div>
        <div className="relative w-full sx:w-[500px] md:w-[600px] lg:w-[800px] 2xl:w-[1000px] mx-auto">
          <div
            data-aos="fade-down"
            data-aos-duration="1000"
            className="sx:absolute 2xl:top-[120px] max-sx:mt-52 max-sx:mx-auto sx:right-[-45px] sx:mt-[500px] w-[290px] slg:w-[300px] md:w-[350px] lg:w-[500px] 2xl:w-[700px] 2xl:h-[420px] h-[320px] bg-slate-900 rounded-md"
            >
            <img
              className="object-cover w-[290px] slg:w-[300px] md:w-[350px] lg:w-[500px] 2xl:w-[700px] 2xl:h-[420px] h-[320px] rounded-md"
              src={auto}
          ...
          <div
            ...
            className="p-12 2xl:top-[120px] max-sx:top-[200px] max-xm:mx-auto max-xm:px-10 text-left w-full absolute sx:left-[-40px] sx:mt-[535px] sx:w-[400px] md:w-[500px] 2xl:h-[350px] 2xl:leading-8 sm:leading-4 leading-4 text-sm 2xl:text-md h-[250px] bg-slate-100 rounded-md shadow-xl"
          >
