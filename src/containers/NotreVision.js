  ...
  return (
    <>
      ...
      <section className="h-[3750px]">
        ...
        <div className="relative w-full sx:w-[500px] md:w-[600px] lg:w-[800px] 2xl:w-[1000px] h-[1000px] 2xl:h-[1200px] sx:bg-[#d2e0e0] rounded-md sx:mx-auto mt-20 sx:mt-10">
          <div
        ...
        <h2 className="mt-20 sx:mt-14 font-extrabold text-2xl text-cyan-500">
        ...
        <div className="relative w-full sx:w-[500px] md:w-[600px] lg:w-[800px] 2xl:w-[1000px] mx-auto">
          <div
            data-aos="fade-right"
            data-aos-duration="1200"
            className="sx:absolute max-sx:mt-10 max-sx:mx-auto sx:left-[-45px] sx:mt-[130px] w-[290px] slg:w-[300px] md:w-[350px] lg:w-[500px] 2xl:w-[700px] 2xl:h-[420px] h-[320px] bg-slate-900 rounded-md"
          >
            <img
              className="object-cover w-[290px] slg:w-[300px] md:w-[350px] lg:w-[500px] 2xl:w-[700px] 2xl:h-[420px] h-[320px] rounded-md"
              src={rpa}
          ...
          <div
            data-aos="fade-left"
            data-aos-duration="1200"
            className="p-12 max-sx:top-[190px] max-xm:mx-auto max-xm:px-10 text-left w-full absolute sx:right-[-40px] sx:mt-[165px] sx:w-[400px] md:w-[500px] 2xl:h-[350px] 2xl:leading-8 sm:leading-4 leading-4 text-sm 2xl:text-md h-[250px] bg-slate-100 rounded-md shadow-xl"
          >
        ...
        <h2 className="relative top-[180px] sx:top-[1080px]  xl:top-[1080px] 2xl:top-[1130px] font-extrabold text-2xl text-cyan-500">
