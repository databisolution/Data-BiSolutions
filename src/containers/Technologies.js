      ...
      <section className="pt-10" data-aos="">
        ...
        <div className=" mx-auto z-0">
          ...
          <TechnoCard
            ...
            imgDesc={PowerBi}
            classObj="3xl:w-[600px] 2xl:w-[420px] xl:h-[300px] sm:w-[290px] 2xl:h-[200px] sm:h-[200px] xm:w-[400px] lg:w-[600px] xl:w-[600px] h-[250px] mx-auto relative 3xl:-top-[100px] 2xl:-top-[200px] 3xl:left-[380px] sm:-top-[60px] rounded-lg backdrop-blur-2xl bg-white/60 shadow-gray-50 shadow-md"
          />
          <TechnoCard
