      ...
      <section className="pt-10" data-aos="">
        ...
        <div className=" mx-auto z-0">
          ...
          <TechnoCard
            ...
            classObj="3xl:w-[600px] 2xl:w-[390px] xl:h-[370px] sm:w-[290px] 2xl:h-[430px] lg:h-[400px] sm:h-[270px] xm:w-[400px] lg:w-[600px] xl:w-[700px] h-[250px] 2xl:w-[600px] mx-auto relative 3xl:-top-[100px] 2xl:-top-[200px] 3xl:left-[380px] sm:-top-[60px] rounded-lg backdrop-blur-2xl bg-white/60 shadow-gray-50 shadow-md"
          />
          <div>
            <TechnoCard
              ...
              classObj="3xl:w-[600px] 2xl:w-[390px] xl:h-[410px] sm:w-[290px] 2xl:h-[290px] sm:h-[200px] xm:w-[400px] lg:h-[230px] lg:w-[700px] xl:w-[600px] h-[250px] 2xl:w-[600px] mx-auto relative 3xl:-top-[100px] 2xl:-top-[200px] 3xl:left-[380px] sm:-top-[60px] rounded-lg backdrop-blur-2xl bg-white/60 shadow-gray-50 shadow-md"
            />
          </div>
          <div>
            <TechnoCard
          ...
          <div>
            <TechnoCard
              ...
              classObj="3xl:w-[600px] 2xl:w-[390px] xl:h-[480px] sm:w-[290px] 2xl:h-[320px] sm:h-[200px] xm:w-[400px] lg:h-[230px] lg:w-[700px] xl:w-[600px] h-[250px] 2xl:w-[600px] mx-auto relative 3xl:-top-[100px] 2xl:-top-[200px] 3xl:left-[380px] sm:-top-[60px] rounded-lg backdrop-blur-2xl bg-white/60 shadow-gray-50 shadow-md"
            />
          </div>
          <Link to="/contact">
